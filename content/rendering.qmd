...
RStudio will recognize that this is a Quarto project by the precense of the `_quarto.yml` file and will see the "Build" tab.  Click the "Render website" button to render to the `_site` folder.
